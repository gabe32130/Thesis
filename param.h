...
#define LOADBALANCE_DOMAIN_LEVEL 8 /* 256^3 grid */
//#define LOADBALANCE_DOMAIN_LEVEL 9 /*  521^3 grid */
//#define LOADBALANCE_DOMAIN_LEVEL 10 /*  1024^3 grid */
//#define LOADBALANCE_DOMAIN_LEVEL 11 /* L/2^this ~ Rvir of Sim*/
//#define LOADBALANCE_DOMAIN_LEVEL 20 /* L/2^this ~ Rvir of Sim*/
...
*=============================================================================*/
#define AHF_MINPART        64     /* minimum number of particles per halo  > 10       */
#define AHF_VTUNE          1.0    /* allow particle velocities VTUNE*v_escape [1,5]   */
